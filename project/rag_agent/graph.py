...
def create_agent_graph(llm, fast_llm, tools_list, checkpointer):
    ...
    agent_builder.add_node("compress_context", partial(compress_context, llm=fast_llm))
    ...
    graph_builder.add_node("summarize_history", partial(summarize_history, llm=fast_llm))
    graph_builder.add_node("rewrite_query", partial(rewrite_query, llm=fast_llm))
